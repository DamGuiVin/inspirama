...
(function( $ ) {
	...
	$.bookPreview.prototype = {
		...
		open: function() {
			...
			self.$triggers.on( "click", function( e ) {
				...
				if ( e.target.className == "button-effect" || e.target.className == "portfolio-book-image" ) {
	...
	$(function() {
		...
		if ( $( document ).width() > 768  ) {
		    $(".masonry-item:nth-of-type(4n), .masonry-item:last-of-type").after("<div class=\"book-preview\"> <a href=\"#\" class=\"book-preview-close\"></a> <div class=\"book-preview-content\"> <h2 class=\"book-preview-title\"></h2> <h4 class=\"book-preview-author\"></h4> <figure class=\"image\"></figure> <!-- Affiliation Section --> <div class=\"book-preview-affiliation\"> <h3>Soutenir Inspirama en achetant ce livre</h3><a target=\"_blank\" href=\"#\" id=\"amazon-url\" title=\"Acheter sur Amazon\"></a><a target=\"_blank\" href=\"#\" id=\"leslibraires-url\" title=\"Acheter sur Les Libraires\"></a><a target=\"_blank\" href=\"#\" id=\"fnac-url\" title=\"Acheter sur La Fnac\"></a><a target=\"_blank\" href=\"#\" id=\"priceminister-url\" title=\"Acheter sur PriceMinister\"></a><a target=\"_blank\" href=\"#\" id=\"recyclivre-url\" title=\"Acheter sur RecycLivre\"></a><a target=\"_blank\" href=\"#\" id=\"ebook-url\" title=\"Acheter sur EBook\"></a><a target=\"_blank\" href=\"#\" id=\"gutenberg-url\" title=\"Acheter sur Gutenberg Project\"></a></div> <!-- End Affiliation Section --> </div> <div class=\"book-preview-desc\"> <h3 class=\"book-preview-recommender\"></h3> <div class=\"book-preview-recommendation\"></div> <div class=\"book-preview-sources\"></div> <div class=\"book-preview-invitation\"></div> </div> </div> </div>");
		// If we are on a tablet or smartphone, there is one Book per row
		} else { 
		    $(".masonry-item").after("<div class=\"book-preview\"> <a href=\"#\" class=\"book-preview-close\"></a> <div class=\"book-preview-desc\"> <div class=\"book-preview-desc-smartphone\"> <h2 class=\"book-preview-title\"></h2> <h4 class=\"book-preview-author\"></h4> </div> <div class=\"book-preview-affiliation\"> <h3>Soutenir Inspirama en achetant ce livre</h3> <a target=\"_blank\" href=\"#\" id=\"amazon-url\" title=\"Acheter sur Amazon\"></a> <a target=\"_blank\" href=\"#\" id=\"leslibraires-url\" title=\"Acheter sur Les Libraires\"></a> <a target=\"_blank\" href=\"#\" id=\"fnac-url\" title=\"Acheter sur La Fnac\"></a> <a target=\"_blank\" href=\"#\" id=\"priceminister-url\" title=\"Acheter sur PriceMinister\"></a> <a target=\"_blank\" href=\"#\" id=\"recyclivre-url\" title=\"Acheter sur RecycLivre\"></a> <a target=\"_blank\" href=\"#\" id=\"ebook-url\" title=\"Acheter sur EBook\"></a> <a target=\"_blank\" href=\"#\" id=\"gutenberg-url\" title=\"Acheter sur Gutenberg Project\"></a> </div> <h3 class=\"book-preview-recommender\"></h3> <div class=\"book-preview-recommendation\"></div> <div class=\"book-preview-sources\"></div> <div class=\"book-preview-invitation\"></div> </div> </div>");
		}
